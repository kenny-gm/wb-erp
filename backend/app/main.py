...
# 迁移：客服 AI 自动回复配置与报告表，默认总开关关闭。
from migrations.add_customer_auto_reply import migrate_add_customer_auto_reply
migrate_add_customer_auto_reply()  # 幂等，重复执行无影响
...
from app.models.models import (
    ...
    AIPromptTemplate, CustomerAutoReplyRun, CustomerAutoReplyItem
)
